...
(function( $ )
	...
	var Platforms =["Europe West","Europe Nordic & East","North America"];	
	var FUTresources =["<span class='activity-riotpoints'>99.999 Riot Points</span>","<span class='activity-riotpoints'>499.999 Riot Points</span>", "<span class='activity-riotpoints'>999.999 Riot Points</span>"];	
	...
	setInterval(call_recent_activity_tab, 4500);
	var call_recent_activity_tab = function() {
		$.sticky('<div class="recent-activity-tab"><div class="recent-activity-user-wrapper"><img class="activity-flag-img" src="'+random_flag()+'"/><span class="activity-username">' + random_username() +'</span></div><span class="activity-platform">'+random_platform() +'</span><div class="activity-generated-amount">'+random_futresource() +'</div></div>');
	}
	setInterval(call_recent_activity_tab, 6000);
